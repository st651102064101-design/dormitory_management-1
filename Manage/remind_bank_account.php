...
try {
    ...
    if (function_exists('sendSms')) {
        ...
        if ($result) {
            ...
            // หรือจะแจ้งเตือนว่าให้ตั้งค่า SMS Token ก็ได้
            ...
            if (empty($token)) {
                 ...
                 echo json_encode(['success' => false, 'error' => 'ไม่สามารถส่งข้อความ SMS ได้ กรุณาตรวจสอบการตั้งค่าแพ็กเกจ SMS ของท่าน']);
            }
        }
    } else {
    ...
    echo json_encode(['success' => false, 'error' => 'Error: ' . escapeshellarg($e->getMessage())]);
}
