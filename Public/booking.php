...
<body>
    ...
    function showAppleAlert(message, title = 'แจ้งเตือน') {
        document.getElementById('appleAlertTitle').textContent = title;
        document.getElementById('appleAlertMessage').textContent = message;
    ...
    document.getElementById('appleAlert')?.addEventListener('click', function(e) {
        if (e.target === this) {
            closeAppleAlert();
        }
    });
