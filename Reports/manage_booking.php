...
<html lang="th">
  <head>
    ...
    <style>
      ...
      /* Mobile responsive card layout for booking table */
      ...
      @media (max-width: 768px) {
        ...
        html.light-theme #table-bookings tbody td:first-child,
        body.live-light #table-bookings tbody td:first-child,
        body.reports-page #table-bookings tbody td:first-child {
          border-bottom-color: rgba(0,0,0,0.1);
        }
      }
    </style>
