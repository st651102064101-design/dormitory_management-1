...
<html lang="th" class="<?php echo $lightThemeClass; ?>">
  ...
  <body class="reports-page">
                      ...
                      <tr data-repair-id="<?php echo (int)$r['repair_id']; ?>" data-status="<?php echo htmlspecialchars($status); ?>">
                        ...
                        <td data-label="นัดหมายซ่อม">
                          ...
                          <div id="schedule-cell-<?php echo (int)$r['repair_id']; ?>">
                            <?php $isDone = ($status === '2' || $status === '3'); ?>
                            <?php if ($hasSchedule): ?>
                              <div class="schedule-badge scheduled<?php echo $isDone ? ' is-done' : ''; ?>"
                                <?php if (!$isDone): ?>
                                  style="cursor:pointer;" onclick="openScheduleModal(<?php echo (int)$r['repair_id']; ?>, '<?php echo htmlspecialchars($r['room_number'] ?? '-', ENT_QUOTES); ?>')"
                                <?php else: ?>
                                  style="cursor:default;opacity:0.5;filter:grayscale(60%);" title="ซ่อมเสร็จแล้ว — ไม่สามารถแก้ไขนัดหมายได้"
                                <?php endif; ?>
    ...
    <script src="/dormitory_management/Public/Assets/Javascript/confirm-modal.js" defer></script>
    <script src="/dormitory_management/Public/Assets/Javascript/toast-notification.js" defer></script>
