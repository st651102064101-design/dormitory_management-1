...
CREATE TABLE IF NOT EXISTS tenant_oauth (
  ...
  UNIQUE KEY unique_provider (tnt_id, provider),
...
-- INSERT INTO tenant_oauth (tnt_id, provider, provider_id, provider_email)
-- VALUES ('1234567890123', 'google', 'google_user_id_here', 'tenant@gmail.com');
