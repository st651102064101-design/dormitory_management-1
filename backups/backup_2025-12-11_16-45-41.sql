...
INSERT INTO `admin` (`admin_id`, `admin_username`, `admin_password`, `admin_name`, `admin_tel`, `admin_line`) VALUES ('1', 'admin01', '$2y$10$M68RPadsYU0TZq9jfA2GE.m.a4FhhAkmN38DRwP2cNTD/BdOen0BG', 'กิตติศักดิ์ โชติวิจิตร', '0891234567', 'kittisak_admin');
...
CREATE TABLE `booking` (
  ...
  `tnt_id` char(13) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'เลขทะเบียนบัตรประจำตัวประชาชน',
  PRIMARY KEY (`bkg_id`),
  KEY `booking_ibfk_1` (`room_id`),
  CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `room` (`room_id`)
) ENGINE=InnoDB AUTO_INCREMENT=71 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `booking` (`bkg_id`, `bkg_date`, `bkg_checkin_date`, `bkg_status`, `room_id`, `tnt_id`) VALUES ('70', '2025-12-10', '2025-12-17', '1', '1', '1100000000012');
...
CREATE TABLE `contract` (
  ...
  `room_id` int DEFAULT NULL COMMENT 'รหัสห้องพัก (FK)',
  `access_token` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Token สำหรับเข้าถึง Tenant Portal',
  PRIMARY KEY (`ctr_id`),
...
INSERT INTO `contract` (`ctr_id`, `ctr_start`, `ctr_end`, `ctr_deposit`, `ctr_status`, `tnt_id`, `room_id`, `access_token`) VALUES ('3', '2025-11-12', '2026-05-12', '2000', '1', '1103700890123', '3', NULL);
INSERT INTO `contract` (`ctr_id`, `ctr_start`, `ctr_end`, `ctr_deposit`, `ctr_status`, `tnt_id`, `room_id`, `access_token`) VALUES ('15', '2025-12-10', '2026-06-10', '2000', '0', '1100000000014', '4', '2be9e15693c6fc3d01303d5918db8502');
INSERT INTO `contract` (`ctr_id`, `ctr_start`, `ctr_end`, `ctr_deposit`, `ctr_status`, `tnt_id`, `room_id`, `access_token`) VALUES ('16', '2025-12-10', '2026-06-10', '2000', '0', '1100000000012', '5', '5287c2762080d977d86d3a4c3843d282');
INSERT INTO `contract` (`ctr_id`, `ctr_start`, `ctr_end`, `ctr_deposit`, `ctr_status`, `tnt_id`, `room_id`, `access_token`) VALUES ('17', '2025-12-10', '2026-06-10', '2000', '0', '1100000000010', '37', '88f34cbbb54a3cda5f4311152863a797');
INSERT INTO `contract` (`ctr_id`, `ctr_start`, `ctr_end`, `ctr_deposit`, `ctr_status`, `tnt_id`, `room_id`, `access_token`) VALUES ('18', '2025-12-10', '2026-06-10', '2000', '0', '1100000000020', '71', '92d0079aa03a3e735b25fa7383d338a6');
...
CREATE TABLE `expense` (
  ...
  `exp_status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'สถานะการชำระเงิน (0=ยังไม่จ่าย, 1=จ่ายแล้ว, 2=รอตรวจสอบ)',
...
INSERT INTO `expense` (`exp_id`, `exp_month`, `exp_elec_unit`, `exp_water_unit`, `rate_elec`, `rate_water`, `room_price`, `exp_elec_chg`, `exp_water`, `exp_total`, `exp_status`, `ctr_id`) VALUES ('15', '2025-12-01', '0', '0', '4', '5', '1500', '0', '0', '1500', '1', '15');
INSERT INTO `expense` (`exp_id`, `exp_month`, `exp_elec_unit`, `exp_water_unit`, `rate_elec`, `rate_water`, `room_price`, `exp_elec_chg`, `exp_water`, `exp_total`, `exp_status`, `ctr_id`) VALUES ('16', '2025-12-01', '0', '0', '4', '5', '1500', '0', '0', '1500', '2', '16');
INSERT INTO `expense` (`exp_id`, `exp_month`, `exp_elec_unit`, `exp_water_unit`, `rate_elec`, `rate_water`, `room_price`, `exp_elec_chg`, `exp_water`, `exp_total`, `exp_status`, `ctr_id`) VALUES ('17', '2025-12-01', '0', '0', '4', '5', '1500', '0', '0', '1500', '0', '17');
INSERT INTO `expense` (`exp_id`, `exp_month`, `exp_elec_unit`, `exp_water_unit`, `rate_elec`, `rate_water`, `room_price`, `exp_elec_chg`, `exp_water`, `exp_total`, `exp_status`, `ctr_id`) VALUES ('18', '2025-12-01', '0', '0', '4', '5', '1500', '0', '0', '1500', '1', '18');
...
INSERT INTO `payment` (`pay_id`, `pay_date`, `pay_amount`, `pay_proof`, `pay_status`, `exp_id`) VALUES ('20', '2025-12-10', '1500', 'payment_1765385050_6939a35aadf5c8.13265357.jpg', '1', '18');
INSERT INTO `payment` (`pay_id`, `pay_date`, `pay_amount`, `pay_proof`, `pay_status`, `exp_id`) VALUES ('23', '2025-12-11', '1500', 'payment_1765387350_6939ac562c66a8.18002693.jpg', '1', '15');
INSERT INTO `payment` (`pay_id`, `pay_date`, `pay_amount`, `pay_proof`, `pay_status`, `exp_id`) VALUES ('25', '2025-12-11', '500', 'payment_1765387726_6939adcebdfc17.93072105.jpg', '0', '16');
...
INSERT INTO `rate` (`rate_id`, `rate_water`, `rate_elec`, `effective_date`, `created_at`) VALUES ('9', '2', '5', '2025-12-10', '2025-12-11 04:40:16');
INSERT INTO `rate` (`rate_id`, `rate_water`, `rate_elec`, `effective_date`, `created_at`) VALUES ('10', '1', '1', '2025-12-10', '2025-12-11 04:41:26');
INSERT INTO `rate` (`rate_id`, `rate_water`, `rate_elec`, `effective_date`, `created_at`) VALUES ('11', '3', '3', '2025-12-11', '2025-12-11 22:16:06');
...
INSERT INTO `repair` (`repair_id`, `repair_desc`, `repair_date`, `repair_time`, `repair_status`, `repair_image`, `ctr_id`) VALUES ('90', 'ดไฟดไฟด', '2025-12-11 00:00:00', '01:24:50', '0', 'repair_1765391090_8e0c1108903934ba.jpg', '18');
...
INSERT INTO `room` (`room_id`, `room_number`, `room_status`, `room_image`, `type_id`) VALUES ('1', '1', '1', 'room01.jpg', '2');
...
INSERT INTO `room` (`room_id`, `room_number`, `room_status`, `room_image`, `type_id`) VALUES ('71', '10', '1', '', '1');
...
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES ('2', 'theme_color', '#0f172a', '2025-12-11 22:40:59');
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES ('3', 'font_size', '0.9', '2025-12-11 22:43:41');
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES ('4', 'logo_filename', 'Logo.jpg', '2025-12-06 13:43:41');
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES ('823', 'bg_filename', 'bg.jpg', '2025-12-11 22:34:36');
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES ('825', 'public_theme', 'auto', '2025-12-11 20:45:36');
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES ('861', 'contact_email', 'test@gmail.com', '2025-12-11 22:29:31');
INSERT INTO `system_settings` (`id`, `setting_key`, `setting_value`, `updated_at`) VALUES ('864', 'use_bg_image', '0', '2025-12-11 22:36:50');
...
INSERT INTO `tenant` (`tnt_id`, `tnt_name`, `tnt_age`, `tnt_address`, `tnt_phone`, `tnt_education`, `tnt_faculty`, `tnt_year`, `tnt_vehicle`, `tnt_parent`, `tnt_parentsphone`, `tnt_status`, `tnt_ceatetime`) VALUES ('1100000000020', 'นางสาวนันทิยา ชัยชนะ', '20', '15/3 ถนนบางนา-ตราด สมุทรปราการ 10540', '0809876543', 'มหาวิทยาลัย D', 'ภาษาศาสตร์', 'ปี 3', NULL, 'นางนงนุช ชัยชนะ', '0801234567', '1', '2025-12-10 04:32:12');
...
INSERT INTO `utility` (`utl_id`, `utl_water_start`, `utl_water_end`, `utl_elec_start`, `utl_elec_end`, `utl_usage`, `utl_date`, `ctr_id`) VALUES ('6', '0', '1', '0', '1', NULL, '2025-12-10', '3');
INSERT INTO `utility` (`utl_id`, `utl_water_start`, `utl_water_end`, `utl_elec_start`, `utl_elec_end`, `utl_usage`, `utl_date`, `ctr_id`) VALUES ('7', '0', '100', '0', '200', NULL, '2025-12-11', '15');
INSERT INTO `utility` (`utl_id`, `utl_water_start`, `utl_water_end`, `utl_elec_start`, `utl_elec_end`, `utl_usage`, `utl_date`, `ctr_id`) VALUES ('8', '0', '50', '0', '100', NULL, '2025-12-11', '16');
INSERT INTO `utility` (`utl_id`, `utl_water_start`, `utl_water_end`, `utl_elec_start`, `utl_elec_end`, `utl_usage`, `utl_date`, `ctr_id`) VALUES ('9', '1', '1', '1', '1', NULL, '2025-12-10', '17');
INSERT INTO `utility` (`utl_id`, `utl_water_start`, `utl_water_end`, `utl_elec_start`, `utl_elec_end`, `utl_usage`, `utl_date`, `ctr_id`) VALUES ('10', '1', '1', '1', '1', NULL, '2025-11-10', '3');
