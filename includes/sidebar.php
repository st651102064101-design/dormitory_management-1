  ...
  <nav class="app-nav" aria-label="Main navigation" >
    <div class="group" >
      <details id="nav-dashboard" open>
        ...
        <a class="" href="Public/booking_status.php"><span class="app-nav-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/></svg></span><span class="app-nav-label">ตรวจสอบสถานะการจอง</span></a>
      </details>
    </div>
  </nav>
