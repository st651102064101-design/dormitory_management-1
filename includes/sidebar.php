  ...
  <nav class="app-nav" aria-label="Tenants navigation">
    <div class="group">
      <details id="nav-tenants" <?php echo $navTenantsOpen ? 'open' : ''; ?>>
        ...
        <a class="<?php echo $currentPage === 'manage_contracts.php' ? 'active' : ''; ?>" href="manage_contracts.php" style="position:relative;padding-right:<?php echo $contractActionBadgeTotal > 0 ? '2.5rem' : ''; ?>"><span class="app-nav-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/></svg></span><span class="app-nav-label"><?php echo __('manage_contracts'); ?></span><?php if ($contractActionBadgeTotal > 0): ?><span style="position:absolute;top:50%;transform:translateY(-50%);right:6px;background:#f59e0b;color:white;border-radius:999px;min-width:22px;height:22px;padding:0 6px;display:inline-flex;align-items:center;justify-content:center;font-size:11px;font-weight:bold;transition:all 0.2s ease-in-out;"><?php echo $contractActionBadgeTotal > 99 ? '99+' : $contractActionBadgeTotal; ?></span><?php endif; ?></a>
