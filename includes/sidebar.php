...
(function() {
  ...
  // ===============================================
  // Google Link Button Handler - Open in popup
  // ===============================================
  document.querySelectorAll('.google-link-btn').forEach(linkBtn => {
    if (linkBtn.href.includes('link_google.php')) {
      linkBtn.addEventListener('click', async (e) => {
        ...
        // ตรวจสอบทุก 500ms ว่า popup ปิดแล้วหรือยัง
